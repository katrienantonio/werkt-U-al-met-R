...
A 3h introductory workshop: learning R by doing, oriented to actuaries and risk managers!
...
`r emo::ji("calendar")` September 6, 2021
<br>
`r emo::ji("clock")` From 9.00am to 12.00pm
<br>
...
A pdf of the lecture sheets can be downloaded [here](https://katrienantonio.github.io/werkt-U-al-met-R/sheets/lecture_sheets_R_workshop.pdf). 
...
[https://rstudio.cloud/spaces/143507/join?access_code=j%2FGjLwr6Pwix9FucSdDT3Q3XIbZARdRt8aii7ttZ](https://rstudio.cloud/spaces/143507/join?access_code=j%2FGjLwr6Pwix9FucSdDT3Q3XIbZARdRt8aii7ttZ)
...
- with the ‘copy’ button (on the right) you can make your own version of the ‘learn R by doing’ project; in this copy you can work on the exercises, add comments etc.
